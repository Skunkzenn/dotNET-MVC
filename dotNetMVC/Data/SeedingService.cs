...
namespace dotNetMVC.Data
{
    ...
    {
        private dotNetMVCContext _context;

        /*Injeção de dependência, quando o seedingservice for criado
         * automaticamente ele vai receber uma instância do Context */
        public SeedingService(dotNetMVCContext context)
        {
            _context = context;
        }
        ...
        {   //testa se existe algum registo na tabela department
            ...
            //Adicionar os objetos criados utilizando o entity framework
            //AddRange permite que você adicione varios objetos de uma vez
